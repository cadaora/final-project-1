...
subset(YA_2020, select = !(names(YA_2020) %in% names(YA_2021))) %>%
  ...
  kable()
```
The 6 additional variables were part of the adult depression questionnaire. I decided to get rid of them since there were other variables I could use to assess depression. 
