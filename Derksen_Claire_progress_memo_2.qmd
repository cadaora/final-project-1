...
##Progress and Plan
I got pretty caught up in deciding which variables to keep so there is still space for more EDA. If there is time I would like to create a small for the 31 variables and tidy the names using the janitor package. For analysis I'd like to repeat 
