...
NSDUH_2021 %>%
  ...
  select((QUESTID2|FILEDATE|STMRSSTDY|#id,filedate,stimulant study
            ...
            IRSUICTHNK| KSSLR6MON:SPDPSTYR|MICATPY|#mental health
            AMDEYR|ASDSHOM2:ASDSSOC2| #adult depression
            IRSEX|IREDUHIGHST2|CATAG7|ENRLCOLLFT2| EDUSCHGRD2|GOVTPROG| INCOME), #demographics         
         IRVAPNICREC) %>%              #vaping
...
NSDUH_2020 %>%
  ...
  select((QUESTID2|FILEDATE|STMRSSTDY|
            ...
            IRSEX|IREDUHIGHST2|CATAG7|COLLENRLFT|EDUSCHGRD2|GOVTPROG| INCOME)&          
